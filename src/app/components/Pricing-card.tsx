...
export default function PricingCard({
  ...
  return (
    <motion.div
      initial={{ x: -200, opacity: 0 }}      // Start from the left with opacity 0
      ...
      viewport={{ once: true }}              // Animate only once when the component enters the viewport
      className="flex flex-col p-8 col-span-1 rounded-3xl bg-[#2D1B69] text-white h-full"
    >
      <div className="mb-8">
